...
const Form4_4 = ({ open, setOpen, data, getFormData }) => {
    ...
    function addRecord() {
        ...
        setLoading(true)
        axios.post(`https://aldprototype.ca:3000/api/geninfoepmarketingdata`, obj)
            .then((resp) => {
    ...
    function edit() {
        setLoading(true)
        axios.put(`https://aldprototype.ca:3000/api/geninfoepmarketingdata/${formData?.row_id}`, formData)
            .then((resp) => {
