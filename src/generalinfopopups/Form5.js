...
const Form5 = ({ open, setOpen, data, getFormData, setData }) => {
    ...
    function addRecord() {
        ...
        setLoading(true)
        axios.post(`https://aldprototype.ca:3000/api/geninfoscienceteamaldstable`, obj)
            .then((resp) => {
    ...
    function edit() {
        setLoading(true)
        axios.put(`https://aldprototype.ca:3000/api/geninfoscienceteamaldstable/${formData?.row_id}`, formData)
            .then((resp) => {
