...
const Form4_5 = ({ open, setOpen, data, getFormData }) => {
    ...
    function addRecord() {
        ...
        setLoading(true)
        axios.post(`https://aldprototype.ca:3000/api/geninforoebcomplianceaudittrail`, obj)
            .then((resp) => {
    ...
    function edit() {
        setLoading(true)
        axios.put(`https://aldprototype.ca:3000/api/geninforoebcomplianceaudittrail/${formData?.row_id}`, formData)
            .then((resp) => {
