...
const Environment = ({ form, index, date }) => {
    const dateFormat = "YYYY-MM-DD";
    return (
        <Collapse accordion className='mb-3'>
            <Panel header={`Environment Form ${index + 1}`} key={index}>
                <div>
                    <div className='mt-3'>
                        <p>Anchor Sub.No.:</p>
                ...
                <div className='mt-5' style={{ textAlign: "end" }}>
                    {/* <a target="_blank" href={`https://aldprototype.ca/general/${form['Anchor Submission Number']}`}> */}
                    <Link to={`/environment/${form['Submission Number']}`}>
